    ...
    html += `
            <article class="card border-0 shadow my-3" style="width: 300px;">
                <div class="card-body bg-primary text-white p-3">
                    ...
                    <h3 class="card-subtitle"><i class="fa-solid fa-laptop"></i> ${data.engineer[
                      i
                    ].getRole()}</h3>
                </div>
                <div class="list-group list-group-flush bg-light py-3">
                    <ul class="card-body mt-3">
                        <li class="list-group-item">ID: ${data.engineer[
                          i
                        ].getId()}</li>
                        <li class="list-group-item">Email: <a href="mailto:${data.engineer[
                          i
                        ].getEmail()}">${data.engineer[i].getEmail()}</a></li>
                        <li class="list-group-item">GitHub: <a href="https://github.com/${data.engineer[
                          i
                        ].getGithub()}" target="_blank" rel="noopener">${data.engineer[
      i
    ].getGithub()}</a></li>
                    </ul>
                </div>
    ...
    html += `
            <article class="card border-0 shadow my-3" style="width: 300px;">
                <div class="card-body bg-primary text-white p-3">
                    ...
                    <h3 class="card-subtitle"><i class="fa-solid fa-graduation-cap"></i> ${data.intern[
                      i
                    ].getRole()}</h3>
                </div>
                <div class="list-group list-group-flush bg-light py-3">
                    <ul class="card-body mt-3">
                        <li class="list-group-item">ID: ${data.intern[
                          i
                        ].getId()}</li>
                        <li class="list-group-item">Email: <a href="mailto:${data.intern[
                          i
                        ].getEmail()}">${data.intern[i].getEmail()}</a></li>
                        <li class="list-group-item">School: ${data.intern[
                          i
                        ].getSchool()}</li>
                    </ul>
                </div>
